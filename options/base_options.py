...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            "--input_nc", type=int, default=26, help="# of input image channels"
        )
        self.parser.add_argument(
            "--output_nc", type=int, default=26, help="# of output image channels"
        )
        self.parser.add_argument(
            "--grps", type=int, default=26, help="# of input groups"
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--use_dropout1",
            action="store_true",
            help="use dropout for the generator in OrnaNet",
        )
        self.parser.add_argument(
            "--max_dataset_size",
            type=int,
        ...
        self.parser.add_argument(
            "--conditional", action="store_true", help="feed input to the discriminator"
        )
        self.parser.add_argument(
            "--conv3d", action="store_true", help="separate channels by 3d convolution?"
        )
        self.parser.add_argument(
            "--blanks",
            type=float,
        ...
        self.parser.add_argument(
            "--rgb", action="store_true", help="consider all three RGB channels"
        )
        self.parser.add_argument(
            "--rgb_in",
            action="store_true",
            help="consider all three RGB channels for input",
        )
        self.parser.add_argument(
            "--rgb_out",
            action="store_true",
            help="consider all three RGB channels for output",
        )
        self.parser.add_argument(
            "--partial",
            action="store_true",
        ...
        self.parser.add_argument(
            "--stack", action="store_true", help="have stacked networks?"
        )
        self.parser.add_argument(
            "--no_Style2Glyph",
            action="store_true",
        ...
        self.parser.add_argument(
            "--flat", action="store_true", help="consider input image as a flat image"
        )
